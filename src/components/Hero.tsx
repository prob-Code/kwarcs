    ...
    >
      <div className="banner-container bg-black relative overflow-hidden h-[50vh] sm:h-[60vh] md:h-[500px] lg:h-[550px] xl:h-[600px] w-full">
        <div className="absolute inset-0 bg-black w-full">
          ...
          >
            <source
              src="public/lovable-uploads/3130284-uhd_3840_2160_30fps.mp4"
              type="video/mp4"
            />
          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            ...
            >
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                We deliver AI-driven scalable IT services to help businesses
                innovate and grow
              </motion.p>
              <motion.div
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              Tailored IT solutions built to meet your specific business needs,
          ...
          >
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              choosing right technology, getting a personalized support
              selecting the right server plan to fit your business needs
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600 text-xs md:text-sm">
              Technology solutions for finance, healthcare, manufacturing,
              edTech, and more
            </p>
          </motion.div>
        </motion.div>
