...
const SEO: React.FC<SEOProps> = ({
  title = 'Kwarcs',
  description = 'Kwarcs Technologies: Pioneering smart engineering solutions with textile sensors for sports, safety, and performance monitoring.',
  type = 'website',
  name = 'Kwarcs Technologies',
  ...
  const currentUrl = `https://Kwarcs.com${location.pathname}`;
  const absoluteImageUrl = imageUrl.startsWith('http') ? imageUrl : `https://Kwarcs.com${imageUrl}`;
  ...
  const organizationStructuredData = {
    ...
    '@type': 'Organization',
    name: 'Kwarcs Technologies',
    url: 'https://Kwarcs.com',
    logo: 'https://Kwarcs.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
    description: 'Pioneering smart engineering solutions with textile sensors',
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'customer service',
      email: 'info@Kwarcs.com'
    },
    sameAs: [
      'https://www.linkedin.com/company/Kwarcs-technologies',
      'https://twitter.com/Kwarcstechnologies'
    ]
  };
  ...
  const blogPostStructuredData = isBlogPost && publishDate ? {
    ...
    author: {
      '@type': 'Organization',
      name: author || 'Kwarcs Technologies',
      url: 'https://Kwarcs.com'
    },
    publisher: {
      '@type': 'Organization',
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://Kwarcs.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
        width: 512,
        height: 512
      },
      url: 'https://Kwarcs.com'
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Kwarcs Technologies" />
      <meta property="og:locale" content="en_US" />
      {isBlogPost && category && <meta property="article:section" content={category} />}
      {isBlogPost && publishDate && <meta property="article:published_time" content={publishDate} />}
      {isBlogPost && modifiedDate && <meta property="article:modified_time" content={modifiedDate} />}
      {isBlogPost && <meta property="article:publisher" content="https://Kwarcs.com" />}
      ...
      <meta name="twitter:site" content="@Kwarcstechnologies" />
      <meta name="twitter:creator" content="@Kwarcstechnologies" />
